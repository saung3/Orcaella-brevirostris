...
Methods: To analyze the relationship of the DQB alleles with few other cetaceans, we will compile sequences from GenBank and align them to the DQB alleles from Irrawaddy dolphin and construct a phylogenetic tree using R and R studio. The data from this approach will help us visualize which group of cetaceans has high similarity with the DQB alleles of Irrawaddy dolphins. This information can clarify more about the maintenance of high variability of MHC genes over time. 
